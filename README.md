...
~~배포된~~ [~~Rest API 문서~~](src/main/resources/static/docs/index.html)를 통해 서버의 API 목록을 확인하실 수 있습니다.  
- 2023/05/28 배포가 중지되었습니다. 프로젝트의 ```src/main/resources/static/docs/index.html``` 에서 api문서를 확인하실 수 있습니다.
